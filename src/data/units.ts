...
This contains some base entries to use for the collection.
*/
...
export const UNITS: UnitItem[] = [
  ...
  {
    id: 'Drifter-Ryoshu',
    name: 'Drifting Blade of Hongyuan',
    sinner: 'Ryoshu',
    type: 'identity',
    rarity: '000',
    imageUrl: 'public/sinnerCards/lcb_yisang.png'
  ...
  {
    id: 'Butler-Outis',
    name: 'The Butler of La Manchaland',
    sinner: 'Outis',
    type: 'identity',
    rarity: '000',
    imageUrl: 'public/sinnerCards/lcb_yisang.png'
